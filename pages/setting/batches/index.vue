          ...
          <template v-slot:table="props">
            ...
            >
              <div class="buttons is-right">
                <nuxt-link
                  :to="{
                    name: 'setting-batches-batch-edit',
                    params: { batch: props.row.uuid }
                  }"
                ...
                <b-button
                  ...
                  type="is-danger"
                  title="Delete"
                  @click.prevent="deleteBatch(props.row)"
                >
...
export default {
  ...
  computed: {
    titleStack() {
      return ['Setting', 'Batches']
    }
  },
  mounted() {},
  methods: {
    showAdd() {
      this.$router.redirect('/setting/batches/create')
    },
    resetForm() {
    ...
    deleteBatch(batch) {
      this.$buefy.dialog.confirm({
        ...
        message: `Are you sure you want to delete unit <b>${batch.name}</b> ?<br/>This action cannot be undone.`,
